...
**01 ICP & Buyer Persona Analysis** Notion page:
`https://app.notion.com/p/3904e4751c3a81dca87af64d0ea85822`

Fetch via the Notion MCP `notion-fetch` tool. Use **§4 (Firm-Wide ICP)** for the addressable
market (industries, size, geography). For the four Eclipse practices and their buyer personas, use
the per-practice department pages (**Section C — Practice ICP Detail**) in the Skill References
database — Data `23e4e4751c3a827480e10109d6538c63`, Risk & Regulatory
`6ce4e4751c3a8331828b818f9efe37b4`, Transformation `3914e4751c3a8147adbac414b716d10f`, Artificial
Intelligence `3914e4751c3a81228cb3c4da2a7711d6`. Fallback persona table if pages are unreachable:
...
```json
{
  ...
  "criteria_fetched_from": {
    "icp_segments_page": "https://app.notion.com/p/3904e4751c3a81dca87af64d0ea85822",
...
markets — fetched fresh from the 01 ICP & Buyer Persona Analysis page.
