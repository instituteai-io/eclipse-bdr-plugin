...
(`https://app.notion.com/p/3904e4751c3a81dca87af64d0ea85822`), §4. Current expected band
(sanity check only — trust the page): **500–2,500 employees, $250M–$1B**, FS-core, US primary.
...
1. Fetch Page A; take the vendor/product list from the Vendor Table (or, if the user named specific
   vendors, just those).
2. Fetch the 01 ICP & Buyer Persona Analysis page; extract size, revenue, industries, geography (§4).
